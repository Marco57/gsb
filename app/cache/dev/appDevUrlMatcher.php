    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/su')) {
            ...
            if ($pathinfo === '/suivrefrais') {
                return array (  '_controller' => 'PgGsbFraisBundle:SuivreFrais:index',  '_route' => 'pg_gsb_frais_suivrefrais',);
            }
        ...
        if ($pathinfo === '/validerfrais') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\ValiderFraisController::indexAction',  '_route' => 'pg_gsb_frais_validerfrais',);
        }

        // pg_gsb_frais_annvaliderfrais
        if ($pathinfo === '/annvaliderfrais') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\ValiderFraisController::annulerAction',  '_route' => 'pg_gsb_frais_annvaliderfrais',);
        }
